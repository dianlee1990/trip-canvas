...
const CustomEvent = ({ event }) => {
 ...
 // [修正] 使用標準 Google Maps Search URL
const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(item.name)}${isRealId ? `&query_place_id=${rawId}` : ''}`;
