...
import {
 ...
 Beer, Landmark, Train, Mountain, Users
} from 'lucide-react';
   ...
   <aside  className ="w-full h-full flex flex-col z-20 bg-white border-r border-gray-200">
     ...
     <div  className ="h-16 min-h-16 max-h-16 border-b border-gray-200 flex items-center justify-between px-4 bg-white shrink-0">
       ...
       <div  className ="flex items-center gap-2 md:hidden">
          ...
          <button  onClick ={onOpenExport}  className ="text-purple-600 bg-purple-50 p-2 rounded-full"><Sparkles  size ={18}/></button>
          <button  onClick ={onOpenShare}  className ="text-teal-600 bg-teal-50 p-2 rounded-full"><Users  size ={18}/></button>
       </div>

       <div  className ="hidden md:flex items-center gap-2 ml-auto">
             <button  onClick ={onOpenExport}  className ="text-purple-600 hover:bg-purple-50 p-2 rounded-full transition-colors"  title = "匯出精美行程" >
                <Sparkles  size ={20}/>
             </button>
        </div>
     </div>
